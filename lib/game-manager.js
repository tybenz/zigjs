define( 'game-manager', [ 'class', 'entity', 'sprite', 'animation', 'image-loader', 'key-handler', 'mouse-handler' ],
function ( Class, Entity, Sprite, Animation, ImageLoader, KeyHandler, MouseHandler ) {
    return Class.extend({
